...
public class Film implements Serializable{
	...
	public static List<Film> getStaticFilms(){
		...
		films.add(new Film("All Cheerleaders Die",R.drawable.acd,"12/05/2014 7:00 PM","All Cheerleaders Die is a 2013 American horror film remake. A high school girl's plot to revenge herself on the captain of the football team turns deadly when phantasmagorical elements are tossed into the mix.","https://www.youtube.com/watch?v=5vIvyff3XMoA","1"));
