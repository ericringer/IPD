...
public class Film implements Serializable{
	...
	public static List<Film> getStaticFilms(){
		...
		films.add(new Film("All Cheerleaders Die",R.drawable.acd,"11/22/2014 7:00 PM","All Cheerleaders Die is a 2013 American horror film remake. A high school girl's plot to revenge herself on the captain of the football team turns deadly when phantasmagorical elements are tossed into the mix.","https://www.youtube.com/watch?v=5vIvyff3XMo","1"));
		films.add(new Film("An American Terror",R.drawable.at,"12/01/2014 5:00 PM","An American Terror is an explosive and surprising modern day horror mash-up. Totally and relentlessly disquieting Ð great atmosphere and sound and perfectly gruesome.","https://www.youtube.com/watch?v=xN5zX58kS04","2"));
		films.add(new Film("Buck Wild",R.drawable.bw,"12/06/2014 9:00 PM","Craig ThompsonÕs idyllic hunting trip with his two buddies and unstable cousin is wrecked after hearing that his fiancŽ and best man-to-be have been cavorting behind his back. To make matters worse, his cousin appears on the verge of a murderous rampage while a rapidly-spreading Chupacabra virus is turning locals into the undead", "https://www.youtube.com/watch?v=iPbKu55otj4", "3"));
		...
		films.add(new Film("Found",R.drawable.found,"12/12/2014 7:00 PM","Marty is the ideal fifth grader. He gets good grades, listens to his teachers, and doesnÕt start trouble in class. But darkness is beginning to fall over MartyÕs life. The kids at school wonÕt stop picking on him, his parents just donÕt seem to understand him, and now Marty must grapple with a terrible secret that threatens to destroy life as he knows it.. ","https://www.youtube.com/watch?v=Eca1gMpVbys","9"));
		...
		films.add(new Film("Septic Man",R.drawable.septic,"12/10/2014 9:00 PM","Jack has a goodÑif somewhat smellyÑlife. He has a beautiful wife and a lovely home in a charming town, and if maintaining that life means occasionally being coated in goo, heÕs fine with that. JackÕs a plumber. A good one. And so when his town is stricken by a contaminated water crisis, itÕs to Jack that the town turns to find and solve the problem while the residents are evacuated away to cleaner pastures. But things donÕt go as planned. Sure, Jack finds the source of the problem deep in a long forgotten sewage treatment holding tank, but heÕs not alone in the plant and the unfriendly denizens trap him within the fetid tank with no food or clean water.","https://www.youtube.com/watch?v=T7zN_GefAs4","19"));
